...
To build the final jar and optimize the FinanzasyTareas application for production, run:
...
Then navigate to [http://localhost:8284](http://localhost:8284) in your browser.
