package dev.juanchi.web.rest;

import static dev.juanchi.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static dev.juanchi.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static dev.juanchi.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import dev.juanchi.IntegrationTest;
import dev.juanchi.security.AuthoritiesConstants;
